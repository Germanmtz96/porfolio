  ...
  return (
    ...
    <div className='experiencia-laboral'>
      ...
      <TimelineItem>
        ...
        <TimelineContent>
          <h1 className="saira-semi-condensed-semibold" style={{color: '#ffbc1b', fontSize: '18px', margin:'0px', marginTop:'-70px'}}>Front-end Web Developer</h1>
          <p className="saira-semi-condensed-medium" style={{color: '#1b1b35', fontSize: '16px', margin:'0px'}}>Open to work</p>
          <span className="saira-semi-condensed-regular" style={{color:'#acacbd', fontSize:'14px'}}>Actualmente...</span>
          <p className="saira-semi-condensed-regular" style={{fontSize:'13.9px',marginTop:'40px', color: 'rgb(75 85 99)'}}>Participé en un programa intensivo de 12 semanas con un total de 450 horas de formación en desarrollo web.
...
<a href="https://github.com/Germanmtz96" style={{color: '#ffbc1b', fontSize: '18px', textDecoration:'none'}}>Ver Github &gt;</a>
          </TimelineContent>
      </TimelineItem>
      <TimelineItem>
        ...
        <TimelineContent>
          <h1 className="saira-semi-condensed-semibold" style={{color: '#ffbc1b', fontSize: '18px', margin:'0px', marginTop:'-70px'}}>Operador Polivalente en Supermercado</h1>
          <p className="saira-semi-condensed-medium" style={{color: '#1b1b35', fontSize: '16px', margin:'0px'}}>Mercadona</p>
          <span className="saira-semi-condensed-regular" style={{color:'#acacbd', fontSize:'14px'}}>Mayo 2019</span>
          <p className="saira-semi-condensed-regular" style={{ color: 'rgb(75 85 99)'}}>He acumulado experiencia en diversas áreas, como carnicería, charcutería, cajero, reparto, y fruta/verdura, lo que me ha permitido desarrollar una gran adaptabilidad y habilidades de trabajo en equipo, dado que todos estos roles requieren coordinar procesos en cadena.</p>
          </TimelineContent>
      </TimelineItem>
      <TimelineItem>
        <TimelineSeparator>
        ...
        <TimelineContent>
          <h1 className="saira-semi-condensed-semibold" style={{color: '#ffbc1b', fontSize: '18px', margin:'0px', marginTop:'-70px'}}>Cocinero</h1>
          <p className="saira-semi-condensed-medium" style={{color: '#1b1b35', fontSize: '16px', margin:'0px'}}>Domino's Pizza</p>
          <span className="saira-semi-condensed-regular" style={{color:'#acacbd', fontSize:'14px'}}>Abril 2016</span>
          <p className="saira-semi-condensed-regular" style={{ color: 'rgb(75 85 99)'}}>Contribuí a la formación del personal en múltiples tiendas que abrieron en la zona de Alicante.</p>
        </TimelineContent>
      </TimelineItem>
    </Timeline>
    </div>
